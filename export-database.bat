...
pg_dump -U postgres -h localhost -p 5432 -d observatorio_regulatorio -s > postgres-init/01-schema.sql

echo Exportando datos de la base de datos...
pg_dump -U postgres -h localhost -p 5432 -d observatorio_regulatorio -a > postgres-init/02-data.sql
